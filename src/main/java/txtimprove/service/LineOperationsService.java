...
@Service
public class LineOperationsService {

    private final ChatClient chatClient;
    private final MessageService messageService;

    public LineOperationsService(ChatClient.Builder chatClientBuilder, MessageService messageService) {
    ...
    public String getDefaultPrompt() {
        return messageService.getMessage("lineops.prompt.default");
    }

    public String processLines(String fileContent, String lineInstruction) {
        return processLines(fileContent, lineInstruction, null, null);
    }

    public String processLines(String fileContent, String lineInstruction, String customPrompt) {
        return processLines(fileContent, lineInstruction, customPrompt, null);
    }

    public String processLines(String fileContent, String lineInstruction, String customPrompt, String selectedModel) {
        try {
            String basePrompt = (customPrompt != null && !customPrompt.trim().isEmpty()) 
                ? customPrompt 
                : getDefaultPrompt();
            
            // Replace placeholders in the prompt
            final String finalPrompt = basePrompt.replace("{file_content}", fileContent)
                          .replace("{line_instruction}", lineInstruction);
